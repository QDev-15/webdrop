  ...
  const templateData: {
    ...
    status: 'published' | 'draft'
      ...
      },
      {
        ...
        description: 'Template shop đồ gia dụng phong cách WARM-ARTISAN — Terracotta + Sage accent, nhà bếp/trang trí/phòng tắm/nội thất nhỏ. Có sẵn tìm kiếm/lọc sản phẩm, giỏ hàng.',
