...
const faqs = [
  { q: 'Thời gian hoàn thành bao lâu?', a: 'Landing page 1 trang: 2–3 ngày. Website nhiều trang: 5–7 ngày. Website custom Gói C: thỏa thuận theo scope.' },
  ...
  { q: 'Giá bao gồm những gì?', a: 'Bao gồm file source, hướng dẫn chỉnh sửa, và hỗ trợ cài đặt (với gói Standard/Pro). Hosting và domain tính riêng.' },
]
          ...
          <div className="wd-container">
            <div className="row g-5">
              ...
              <div className="col-lg-4 reveal">
                ...
                {[
                  { icon: '📍', label: 'Địa chỉ', val: 'Tây Hồ, Hà Nội' },
                  { icon: '📞', label: 'Zalo / Điện thoại', val: '0901 234 567' },
                  { icon: '✉️', label: 'Email', val: 'hello@webdrop.vn' },
                  { icon: '🕐', label: 'Giờ hỗ trợ', val: '8:00–18:00 · T2–T7' },
                ].map(i => (
                      ...
                      <div className="row g-3">
                        ...
                        <div className="col-md-6">
                          ...
                          <select value={form.service} onChange={e => setForm(f => ({ ...f, service: e.target.value }))}
                            ...
                            <option>Mua template (Gói A)</option>
                            <option>Website chuẩn (Gói B)</option>
                            <option>Website custom (Gói C)</option>
                            <option>Khác</option>
                          </select>
                        </div>
