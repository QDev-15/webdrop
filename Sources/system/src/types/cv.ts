...
export const CV_TEMPLATE_TYPES = [
  ...
  { value: 'modern', label: 'Modern', desc: 'Emerald gradient, 2 cột' },
  { value: 'academic', label: 'Academic', desc: 'Học thuật, navy, single column' },
  { value: 'compact', label: 'Compact', desc: '3 cột, orange, dày thông tin' },
  { value: 'retro', label: 'Retro', desc: 'Vintage parchment, typewriter' },
  { value: 'gradient', label: 'Gradient', desc: 'Sidebar tím-indigo-cyan' },
  { value: 'minimalist', label: 'Minimalist', desc: 'Trắng đen thuần túy, editorial' },
  { value: 'split', label: 'Split', desc: '50/50 dark-light, pink accent' },
  { value: 'neon', label: 'Neon', desc: 'Cyberpunk, neon green, dark' },
  { value: 'pastel', label: 'Pastel', desc: 'Pastel cards, friendly' },
  { value: 'magazine', label: 'Magazine', desc: 'Editorial magazine, amber/gold' },
] as const
