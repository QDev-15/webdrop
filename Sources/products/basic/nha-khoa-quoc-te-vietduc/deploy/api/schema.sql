-- Nha Khoa Quoc Te Viet Duc — CLEAN-CORPORATE — SQLite Schema
...
-- Extension: doctors (doi ngu bac si — trong nuoc va quoc te)
CREATE TABLE IF NOT EXISTS doctors (
    id               INTEGER PRIMARY KEY AUTOINCREMENT,
    name             TEXT NOT NULL,
    role             TEXT NOT NULL DEFAULT '',
    flag             TEXT NOT NULL DEFAULT 'Trong nuoc',
...
-- Extension: bookings (dat lich kham — co chi nhanh)
