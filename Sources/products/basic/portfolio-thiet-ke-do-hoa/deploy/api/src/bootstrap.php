...
require_once __DIR__ . '/controllers/ToolSkillController.php';
...
// ─── Extension: Dự án (case study Brand Identity & Packaging) ───────────────
...
// ─── Extension: Timeline (Hành trình làm nghề) ─────────────────────────────
...
// ─── Extension: Tools/Skills (Công cụ & kỹ năng) ───────────────────────────
$toolSkill = new ToolSkillController($db);
$router->add('GET',  '/tools-skills',            [$toolSkill, 'index']);
$router->add('GET',  '/tools-skills/:id',        [$toolSkill, 'show']);
$router->add('POST', '/tools-skills',            [$toolSkill, 'store']);
$router->add('POST', '/tools-skills/:id/update', [$toolSkill, 'update']);
$router->add('POST', '/tools-skills/:id/delete', [$toolSkill, 'destroy']);
...
$router->add('GET',  '/public/tools-skills',      [$pub, 'toolsSkills']);
