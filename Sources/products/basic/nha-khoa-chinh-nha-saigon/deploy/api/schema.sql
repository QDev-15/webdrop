-- Nha Khoa Chinh Nha Sai Gon — SQLite Schema
...
-- Core: hero_slides (column names match scaffold HeroSlideController)
...
-- Extension: doctors (bac si chuyen khoa)
CREATE TABLE IF NOT EXISTS doctors (
    id               INTEGER PRIMARY KEY AUTOINCREMENT,
    name             TEXT NOT NULL,
    role             TEXT NOT NULL DEFAULT 'Chuyen khoa Chinh nha',
