...
class ShopPublicController {
    ...
    public function products(): void {
        ...
        // ▼ AI: mở rộng riêng cho shop-van-phong-pham — lọc theo brand (thương hiệu) + theme (section trang chủ)
    ...
    public function sitemap(): void {
        ...
        // Site này dùng biến thể SEARCH-FIRST UNIFIED — catalog đầy đủ nằm ngay ở '/', không có
        // trang '/san-pham' riêng. Các trang tĩnh khác của site: bo-suu-tap, khuyen-mai, dich-vu.
