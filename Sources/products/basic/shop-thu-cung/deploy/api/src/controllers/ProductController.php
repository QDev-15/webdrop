...
// Admin: CRUD sản phẩm — mở rộng BASE_FIELDS với cột riêng shop-thu-cung (pet_type/brand/size/sold/gallery)
// khớp schema.sql + toolbar filter thật của website (index.html). Có phân trang + tìm kiếm (rule 23).
class ProductController {
    ...
    private const BASE_FIELDS = [
        ...
        // ▼ Cột riêng shop-thu-cung (thú cưng)
        'pet_type' => 's', 'brand' => 's', 'size' => 's', 'sold' => 'i', 'gallery' => 's',
    ];
