<?php
/**
 * portfolio-minh-hoa — Cấu hình hệ thống
...
define('DB_FILE', __DIR__ . '/database/portfolio-minh-hoa.db');
...
define('APP_KEY', '46c3af323d7de75878897334c3513e434df03ed08d564c38c834094fd482a41b');
...
define('SMTP_FROM_NAME', 'Lam Trúc Illustration'); define('SMTP_FROM_EMAIL', '');
