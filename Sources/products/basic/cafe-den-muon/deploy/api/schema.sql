...
-- Site: cafe-den-muon (NOX — Cà phê đêm muộn, type=cafe)
-- ═══════════════════════════════════════════════════════════════════════════
...
-- category: '' = ảnh quán chung (masonry khong-gian.html) | 'khu-vuc' = khu vực/area card
-- (4 khu vực: Coding Corner, Phòng Học Nhóm, Quầy Bar Espresso, Góc Sofa Thư Giãn)
-- Với category='khu-vuc': description dòng đầu = tagline ngắn (vd "Bàn đơn · Ổ cắm 100%..."),
-- các dòng sau = mô tả đầy đủ — parse bằng split('\n') phía frontend.
...
-- FAQ accordion (gioi-thieu.html — 7 câu hỏi)
CREATE TABLE IF NOT EXISTS faqs (
    id         INTEGER PRIMARY KEY AUTOINCREMENT,
    question   TEXT NOT NULL,
    answer     TEXT NOT NULL,
    page       TEXT NOT NULL DEFAULT 'gioi-thieu',
    sort_order INTEGER NOT NULL DEFAULT 0,
    status     TEXT NOT NULL DEFAULT 'published'
);
