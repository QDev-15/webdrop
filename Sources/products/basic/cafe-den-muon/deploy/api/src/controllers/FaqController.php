...
class FaqController {
    ...
    public function store(array $p): void {
        ...
        $id = $this->db->execute(
            ...
            [$b['question'], $b['answer'], $b['page'] ?? 'gioi-thieu', (int)($b['sort_order'] ?? 0), $b['status'] ?? 'published']
        );
    ...
    public function update(array $p): void {
        ...
        $this->db->execute(
            ...
            [$b['question'], $b['answer'], $b['page'] ?? 'gioi-thieu', (int)($b['sort_order'] ?? 0), $b['status'] ?? 'published', $p['id']]
        );
