...
CREATE TABLE IF NOT EXISTS products (
    ...
    -- ▼ Mở rộng riêng cho shop-may-anh (theo san-pham.html/chi-tiet-san-pham.html):
    brand           TEXT NOT NULL DEFAULT '',  -- Sony|Canon|Fujifilm|Nikon — khớp bộ lọc "Thương hiệu" (chỉ áp dụng thân máy/ống kính)
    gallery         TEXT NOT NULL DEFAULT '',  -- pipe-separated URL ảnh phụ (trang chi tiết, ngoài ảnh chính `image`)
    bundle_options  TEXT NOT NULL DEFAULT '',  -- pipe-separated "Gói phụ kiện" (vd "Chỉ thân máy|Kèm ống kính kit...")
    specs           TEXT NOT NULL DEFAULT '',  -- pipe-separated "Nhãn:Giá trị" — tab "Thông số kỹ thuật"
