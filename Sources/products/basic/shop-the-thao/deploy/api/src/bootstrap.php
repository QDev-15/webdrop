...
// Media (menu "Thư viện ảnh" độc lập)
...
// Unsplash — GET /unsplash tìm ảnh, POST /unsplash track download (khớp UnsplashPicker.tsx)
...
$router->add('GET',  '/public/categories',          [$shopPub, 'productCategories']);
