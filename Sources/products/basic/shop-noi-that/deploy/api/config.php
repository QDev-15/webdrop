<?php
/**
 * shop-noi-that (MỘC AN) — Cấu hình hệ thống
...
define('DB_FILE', __DIR__ . '/database/shop-noi-that.db');
...
define('APP_KEY', '1586bc01a49bb933d0eca1aa074b2e96f6ecba1d389aedac72e6cf47d61db72c');
