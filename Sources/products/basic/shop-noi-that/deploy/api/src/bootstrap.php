...
// Media (menu "Thư viện ảnh" độc lập — /media/upload là route hay bị bỏ sót nhất)
...
// Unsplash — GET tìm ảnh, POST /unsplash/download track download (khớp UnsplashPicker.tsx)
...
// ─── Bộ sưu tập / Đánh giá / Mã giảm giá (admin CRUD) ──────────────────────────
$collections = new CollectionController($db);
$router->add('GET',  '/collections',            [$collections, 'index']);
$router->add('GET',  '/collections/:id',        [$collections, 'show']);
$router->add('POST', '/collections',            [$collections, 'store']);
$router->add('POST', '/collections/:id/update', [$collections, 'update']);
$router->add('POST', '/collections/:id/delete', [$collections, 'destroy']);
...
$router->add('GET',  '/public/collections', [$pub, 'collections']);
$router->add('GET',  '/public/testimonials',[$pub, 'testimonials']);
$router->add('GET',  '/public/coupons',     [$pub, 'coupons']);
