...
class ProductController {
    ...
    private const BASE_FIELDS = [
        ...
        // ▼ Cột riêng shop-thuc-pham-sach (đồng bộ với schema.sql + admin/src/pages/products/ProductForm.tsx)
        'unit' => 's', 'certs' => 's', 'gallery' => 's', 'nutrition' => 's',
        'origin_farm' => 's', 'harvest_note' => 's', 'sold_count' => 'i', 'stock_qty' => 'i',
    ];
