...
class ProjectController {
    private const FIELDS = [
        'title', 'slug', 'category', 'image', 'location', 'year', 'has_case_study',
        'client_name', 'area', 'duration', 'budget', 'cover_image',
        'challenge_title', 'challenge_body', 'solution_title', 'solution_layout', 'solution_items',
    ...
    private function extractValues(array $b, string $slug): array {
        ...
        foreach (self::FIELDS as $col) {
            ...
            if ($col === 'solution_layout') { $values[] = $b[$col] ?? 'grid'; continue; }
