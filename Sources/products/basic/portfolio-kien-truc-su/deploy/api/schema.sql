...
-- ── PROJECTS (du-an.html list + du-an-chi-tiet-1/2.html case study) ──
-- Mỗi dự án là 1 thẻ trong du-an.html; nếu has_case_study=1 thì có thêm trang chi tiết
-- đầy đủ 7 mục (overview bar, thách thức, giải pháp, gallery, kết quả, đánh giá, liên quan).
CREATE TABLE IF NOT EXISTS projects (
    ...
    solution_title          TEXT NOT NULL DEFAULT '',
    solution_layout          TEXT NOT NULL DEFAULT 'grid',
...
-- ── TESTIMONIALS (ve-toi.html grid đầy đủ + teaser trang chủ) ──
