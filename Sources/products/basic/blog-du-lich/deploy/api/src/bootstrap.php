...
// ─── Extension: Điểm đến được yêu thích (bento trang chủ) ──────────────────
$destination = new DestinationController($db);
$router->add('GET',  '/destinations',            [$destination, 'index']);
$router->add('GET',  '/destinations/:id',        [$destination, 'show']);
$router->add('POST', '/destinations',            [$destination, 'store']);
$router->add('POST', '/destinations/:id/update', [$destination, 'update']);
$router->add('POST', '/destinations/:id/delete', [$destination, 'destroy']);
...
$router->add('GET',  '/public/related-posts/:slug', [$pub, 'relatedPosts']);
$router->add('GET',  '/public/destinations',       [$pub, 'destinations']);
