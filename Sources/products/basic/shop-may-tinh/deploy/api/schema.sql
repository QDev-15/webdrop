...
CREATE TABLE IF NOT EXISTS products (
    ...
    -- ▼ Cột riêng cho shop-may-tinh (san-pham.html / chi-tiet-san-pham.html):
    gallery         TEXT NOT NULL DEFAULT '', -- pipe-separated URL ảnh phụ (gallery thumbs trang chi tiết)
    config_options  TEXT NOT NULL DEFAULT '', -- pipe-separated cấu hình RAM/Ổ cứng, vd "8GB / 256GB|16GB / 512GB|32GB / 1TB"
    specs           TEXT NOT NULL DEFAULT '', -- pipe-separated "Nhãn:Giá trị" cho tab Thông số kỹ thuật
    review_count    INTEGER NOT NULL DEFAULT 0 -- số lượng đánh giá hiển thị cạnh rating
);
