...
CREATE TABLE IF NOT EXISTS products (
    ...
    -- ▼ Cột riêng cho shop-dong-ho (đồng hồ) — khớp Template Analysis Document
    brand        TEXT NOT NULL DEFAULT '',   -- CASIO/SEIKO/CITIZEN/ORIENT/TISSOT/FOSSIL/MVMT/TIMEX/LONGINES/DANIEL WELLINGTON
    material     TEXT NOT NULL DEFAULT '',   -- da | kim-loai | cao-su | vai
    style        TEXT NOT NULL DEFAULT '',   -- co-dien | the-thao | sang-trong | smartwatch
    warranty     TEXT NOT NULL DEFAULT '',
    movement     TEXT NOT NULL DEFAULT '',
    water_resist TEXT NOT NULL DEFAULT '',
    diameter     INTEGER NOT NULL DEFAULT 0, -- mm
    sold         INTEGER NOT NULL DEFAULT 0,
    limited      INTEGER NOT NULL DEFAULT 0, -- 1 = phiên bản giới hạn
    gallery      TEXT NOT NULL DEFAULT ''    -- pipe-separated ảnh phụ, ngoài "image" chính
);

-- Đánh giá khách hàng — hiển thị ở trang chủ (3 thẻ) + trang Giới thiệu, quản lý qua admin CRUD.
