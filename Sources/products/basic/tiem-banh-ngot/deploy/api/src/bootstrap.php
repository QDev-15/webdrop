...
// Reuse MenuCategoryController — it maps to product_categories table via override
$prodCat = new MenuCategoryController($db);
...
// ── Products (Bánh ngọt) ──────────────────────────────────────────────────────
$product = new MenuItemController($db);
...
// ── Orders (Đặt bánh) ─────────────────────────────────────────────────────────
$order = new ReservationController($db);
$router->add('GET',  '/orders',             [$order, 'index']);
$router->add('POST', '/orders',             [$order, 'store']);
$router->add('GET',  '/orders/:id',         [$order, 'show']);
$router->add('POST', '/orders/:id/update',  [$order, 'update']);
$router->add('POST', '/orders/:id/delete',  [$order, 'destroy']);
