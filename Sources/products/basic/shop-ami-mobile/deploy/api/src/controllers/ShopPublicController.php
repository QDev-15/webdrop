...
class ShopPublicController {
    ...
    public function products(): void {
        ...
        // brands/theme: mở rộng riêng cho shop-ami-mobile (site có cột brand/theme — xem schema.sql comment)
    ...
    public function sitemap(): void {
        ...
        $staticRoutes = ['/', '/san-pham', '/khuyen-mai', '/ve-chung-toi', '/lien-he', '/chinh-sach-bao-mat', '/dieu-khoan'];
