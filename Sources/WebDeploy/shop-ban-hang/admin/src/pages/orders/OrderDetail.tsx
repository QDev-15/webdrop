    ...
    <div className="admin-page">
      ...
      <div className="form-row" style={{ alignItems: 'flex-start', gap: 24 }}>
        <div style={{ flex: 2 }}>
          ...
          <div style={{ marginTop: 16, padding: 20, background: '#faf7f3', borderRadius: 12 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 600, fontSize: 16, borderTop: '1px solid #e8dfd4', paddingTop: 8 }}><span>Tổng cộng</span><span>{fmt(order.total)}</span></div>
          </div>
        </div>
