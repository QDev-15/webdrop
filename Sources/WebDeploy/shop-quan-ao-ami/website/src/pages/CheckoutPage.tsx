...
export default function CheckoutPage() {
  ...
  useDocumentMeta({
    title: `Thanh toán — ${settings.site_name || 'AMI Fashion'}`,
    description: `Hoàn tất đơn hàng và thanh toán tại ${settings.site_name || 'AMI Fashion'}.`,
  })
        ...
        <div className="shop-checkout-layout">
          ...
          <aside>
            <div className="shop-checkout-summary">
              ...
              {couponDiscount > 0 && (
                <div className="shop-checkout-summary-row" style={{ color: 'var(--sage, #6b8067)' }}>
