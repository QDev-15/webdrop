    ...
    <div className="admin-page">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">PIXEL. Blog Công Nghệ — Quản trị hệ thống</div>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#fef7d9' }}>🖼</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-card-label">Bài viết ({stats?.published ?? 0} đã đăng)</div>
              <Link to="/posts" className="btn-ghost btn-sm" style={{ marginTop: 12 }}>Quản lý →</Link>
            </div>

            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#fef7d9' }}>⭐</div>
              <div className="stat-card-value">{stats?.reviews ?? 0}</div>
              <div className="stat-card-label">Bài đánh giá sản phẩm</div>
              <Link to="/posts" className="btn-ghost btn-sm" style={{ marginTop: 12 }}>Quản lý →</Link>
            </div>
