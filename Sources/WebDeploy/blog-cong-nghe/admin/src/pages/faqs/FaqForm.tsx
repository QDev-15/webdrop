...
const empty: FaqForm = { question: '', answer: '', sort_order: 0, status: 'published' }
...
export default function FaqFormPage() {
  ...
  useEffect(() => {
    ...
    api.get<FaqForm & { id: number }>(`/faqs/${id}`)
      .then(d => setForm({ question: d.question, answer: d.answer, sort_order: d.sort_order ?? 0, status: d.status ?? 'published' }))
    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={form.question} onChange={e => set('question', e.target.value)} placeholder="Vd: Làm sao để đóng góp bài viết cho PIXEL.?" required />
        </div>
        <div className="form-group">
