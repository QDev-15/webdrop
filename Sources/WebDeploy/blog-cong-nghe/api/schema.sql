...
-- post_categories — Chuyên mục bài viết (Tin tức, Đánh giá, Thủ thuật, AI & Xu hướng, Bảo mật, Di động)
...
-- posts — Bài viết blog. Cũng dùng cho "Đánh giá sản phẩm" (review_score IS NOT NULL = bài đánh giá).
CREATE TABLE IF NOT EXISTS posts (
    ...
    review_score       REAL,
    review_score_label TEXT NOT NULL DEFAULT '',
...
-- faqs — Câu hỏi thường gặp (hiển thị ở trang chủ)
