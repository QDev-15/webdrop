...
export default function HeroSlider() {
  ...
  return (
    <section className="cn-hero">
      <div className="cn-hero-dark" aria-hidden="true" />
        ...
        <div className="cn-hero-inner">
          <div className="cn-hero-text" data-reveal>
            ...
            <div className="cn-hero-stats">
              <div>
                <div className="cn-hero-stat-num">{cases}+</div>
                <div className="cn-hero-stat-lbl">Ca chỉnh nha thành công</div>
              </div>
              <div>
                <div className="cn-hero-stat-num">{years} năm</div>
                <div className="cn-hero-stat-lbl">Kinh nghiệm chuyên khoa</div>
              </div>
              <div>
                <div className="cn-hero-stat-num">{satisfy}%</div>
                <div className="cn-hero-stat-lbl">Khách hàng hài lòng</div>
              </div>
            </div>
          </div>

          <div className="cn-hero-visual" data-reveal data-delay="2" aria-hidden="true">
            <div className="cn-hero-frame" />
            <div className="cn-hero-grid">
              {['', 'mid', '', '', '', 'on', 'on', 'mid', 'mid', 'on', 'on', '', '', '', 'mid', ''].map((cls, i) => (
