  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <div className="page-title">Danh mục dịch vụ niềng răng</div>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input className="form-control" value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} placeholder="VD: Mắc cài niềng răng" />
            </div>
            <div className="form-group" style={{ marginBottom: 0 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button onClick={cancelForm} className="btn-ghost">Huỷ</button>
          </div>
        </div>
      )}
