      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-row">
          <div className="form-group" style={{ flex: 1 }}>
            ...
            <input type="text" className="form-control" value={form.author_name} onChange={e => set('author_name', e.target.value)} placeholder="VD: Thu Hà" />
          </div>
          <div className="form-group" style={{ flex: 1 }}>
            <label>Chức danh / khu vực</label>
            <input type="text" className="form-control" value={form.author_role} onChange={e => set('author_role', e.target.value)} placeholder="VD: Khách hàng tại TP.HCM" />
          </div>
        </div>
