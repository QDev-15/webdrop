  ...
  return (
    <>
      ...
      <div className="form-group">
        ...
        <input type="password" className="form-control" value={val('sepay_webhook_secret')} onChange={e => set('sepay_webhook_secret', e.target.value)} placeholder="Lấy tại my.sepay.vn → Cài đặt công ty → API Access" />
      </div>
      ...
      <div className="form-group">
        ...
        <input type="text" className="form-control" value={val('sepay_bank_code')} onChange={e => set('sepay_bank_code', e.target.value)} placeholder="VD: MB, VCB, TCB, ACB" />
      </div>
      <div className="form-group">
        <label>Số tài khoản</label>
        <input type="text" className="form-control" value={val('sepay_account_number')} onChange={e => set('sepay_account_number', e.target.value)} placeholder="0123456789" />
      </div>
      <div className="form-group">
        <label>Tên chủ tài khoản</label>
        <input type="text" className="form-control" value={val('sepay_account_name')} onChange={e => set('sepay_account_name', e.target.value)} placeholder="NGUYEN VAN A" />
      </div>
      ...
      <div className="form-row">
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input type="number" className="form-control" value={val('shipping_fee')} onChange={e => set('shipping_fee', e.target.value)} placeholder="30000" />
        </div>
        <div className="form-group" style={{ flex: 1 }}>
          <label>Miễn phí vận chuyển từ (VND)</label>
          <input type="number" className="form-control" value={val('free_shipping_threshold')} onChange={e => set('free_shipping_threshold', e.target.value)} placeholder="500000" />
        </div>
      </div>
    </>
  )
