...
export default function Sidebar() {
  ...
  const menuStructure: MenuSection[] = [
    ...
    { section: 'Bất động sản', links: [
      { to: '/properties', icon: '🏠', label: 'Tin đăng' },
      { to: '/agents', icon: '🧑‍💼', label: 'Môi giới' },
      { to: '/projects', icon: '🏗', label: 'Dự án phân phối' },
    ]},
  ...
  return (
    <div className="admin-sidebar">
      <div className="sidebar-logo"><span>NĐ</span> Nhà Đất Việt</div>
