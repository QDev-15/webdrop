...
interface Stats {
  properties: number
  properties_ban: number
  properties_thue: number
  agents: number
  projects: number
  faqs: number
  testimonials: number
...
export default function Dashboard() {
  ...
  const cards = [
    { icon: '🏠', label: 'Tin đăng bất động sản', value: stats.properties, sub: `${stats.properties_ban} bán · ${stats.properties_thue} cho thuê`, to: '/properties' },
    { icon: '🧑‍💼', label: 'Môi giới', value: stats.agents, to: '/agents' },
    { icon: '🏗', label: 'Dự án phân phối', value: stats.projects, to: '/projects' },
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Tổng quan hệ thống Nhà Đất Việt</div>
        </div>
      </div>
