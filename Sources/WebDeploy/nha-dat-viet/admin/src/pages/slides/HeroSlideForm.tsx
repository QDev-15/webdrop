    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={form.title} onChange={e => set('title', e.target.value)} placeholder="Vd: Tìm đúng *ngôi nhà* bạn đang tìm kiếm" required />
          <div className="form-hint">Đặt cụm từ trong dấu * để tô màu accent, vd: Tìm đúng *ngôi nhà*</div>
        </div>
        <div className="form-group">
          <label className="form-label">Nhãn nhỏ (eyebrow) || Mô tả</label>
          <textarea className="form-control" value={form.subtitle} onChange={e => set('subtitle', e.target.value)} placeholder="Sàn giao dịch bất động sản TP.HCM||Nội dung mô tả slide..." />
          <div className="form-hint">Định dạng: [nhãn nhỏ phía trên tiêu đề]||[đoạn mô tả]</div>
        </div>
