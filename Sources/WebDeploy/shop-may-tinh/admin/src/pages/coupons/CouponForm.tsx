      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-row">
          <div className="form-group" style={{ flex: 1 }}>
            ...
            <input type="number" value={form.value} onChange={e => set('value', e.target.value)} min={0} placeholder={form.type === 'percent' ? 'VD: 10' : 'VD: 100000'} />
          </div>
          <div className="form-group" style={{ flex: 1 }}>
            <label>Đơn hàng tối thiểu (VND)</label>
            <input type="number" value={form.min_order} onChange={e => set('min_order', e.target.value)} min={0} placeholder="VD: 2000000" />
          </div>
        </div>
