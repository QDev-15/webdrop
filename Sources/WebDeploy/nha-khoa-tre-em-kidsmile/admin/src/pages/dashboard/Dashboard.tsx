...
export default function Dashboard() {
  ...
  const cards = [
    { icon: '📅', label: 'Đặt lịch mới', value: stats.bookings_new ?? 0, sub: `${stats.bookings_total ?? 0} tổng`, link: '/bookings', color: '#9b7ef0' },
    { icon: '✉️', label: 'Liên hệ mới', value: stats.contacts_new ?? 0, sub: `${stats.contacts_total ?? 0} tổng`, link: '/contacts', color: '#34c98e' },
    { icon: '🦷', label: 'Dịch vụ', value: stats.services_total ?? 0, sub: 'đang hoạt động', link: '/services', color: '#7c5ee0' },
    { icon: '👨‍⚕️', label: 'Bác sĩ', value: stats.team_total ?? 0, sub: 'trong đội ngũ', link: '/team', color: '#23a877' },
  ]
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">KidSmile — Nha Khoa Trẻ Em · SOFT-PASTEL</div>
        </div>
      </div>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          <Link to="/articles/new" className="btn-accent btn-sm">📚 Thêm bài viết</Link>
