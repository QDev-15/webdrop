...
$router->add('GET',  '/public/articles',            [$pub, 'articles']);
...
// ── Articles (Cẩm nang cha mẹ) ───────────────────────────────────────────
$router->add('GET',  '/articles',              [$article, 'index']);
$router->add('POST', '/articles',              [$article, 'store']);
$router->add('GET',  '/articles/:id',          [$article, 'show']);
$router->add('POST', '/articles/:id/update',   [$article, 'update']);
$router->add('POST', '/articles/:id/delete',   [$article, 'destroy']);
