  ...
  return (
    <div className="admin-sidebar">
      <div className="sidebar-logo">
        ...
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', lineHeight: 1.2 }}>Ẩm Thực</div>
          <div style={{ fontSize: 10, color: 'rgba(255,255,255,.35)', lineHeight: 1.2 }}>Admin Panel</div>
        </div>
      </div>
      ...
      <div className="sidebar-footer">
        ...
        >
          <span className="icon">🚪</span>
          <span style={{ color: 'rgba(255,255,255,.45)', fontSize: 13 }}>Đăng xuất</span>
        </button>
      </div>
    </div>
  )
