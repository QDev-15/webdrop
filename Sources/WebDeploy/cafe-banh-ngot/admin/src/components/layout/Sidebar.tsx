...
export default function Sidebar() {
  ...
  useEffect(() => {
    api.get<{ contacts_new: number }>('/stats')
      .then(data => setNewContacts(data.contacts_new))
      .catch(() => {})
  }, [])
  ...
  return (
    <div className="admin-sidebar">
      <div className="sidebar-logo">
        <span>🌸</span> Rosette <span style={{ color: 'rgba(255,255,255,.35)', fontSize: '11px' }}>Admin</span>
      </div>
