...
const FIELD_MAP: Record<string, { key: string; label: string; type?: string; hint?: string }[]> = {
  general: [
    ...
    { key: 'working_hours', label: 'Giờ làm việc', hint: 'VD: T2–T7: 8:00–20:00 | CN: 9:00–17:00' },
  ...
  footer: [
    { key: 'footer_copy', label: 'Copyright / Bản quyền', hint: 'VD: © 2026 Future Dental. Bảo lưu mọi quyền.' },
  ],
  contact: [
  ...
  hero: [
    { key: 'hero_title_main',   label: 'Tiêu đề Hero chính' },
    { key: 'hero_subtitle',     label: 'Mô tả Hero', type: 'textarea' },
    { key: 'stat_years',        label: 'Số năm kinh nghiệm (stat)' },
    { key: 'stat_cases',        label: 'Số ca Implant thành công (stat)' },
    { key: 'stat_doctors',      label: 'Số bác sĩ (stat)' },
    { key: 'stat_satisfaction', label: 'Tỷ lệ tích hợp xương % (stat)' },
  ],
  cloudinary: [
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Quản lý thông tin, SEO và tích hợp của Future Dental</div>
        </div>
