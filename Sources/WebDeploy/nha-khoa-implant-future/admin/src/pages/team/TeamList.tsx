  ...
  return (
    <>
      <div className="page-header">
        <div>
          <div className="page-title">Bác sĩ chuyên sâu</div>
          <div className="page-sub">Quản lý đội ngũ bác sĩ Implant của Future Dental</div>
        </div>
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              ...
              {items.length === 0 && (
                <tr><td colSpan={6} style={{ textAlign: 'center', color: 'var(--text-3)', padding: '40px' }}>Chưa có bác sĩ nào</td></tr>
              )}
            </tbody>
          </table>
        </div>
