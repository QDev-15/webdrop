...
export default function Dashboard() {
  ...
  const cards = [
    ...
    { label: 'Dịch vụ Implant', value: stats?.services ?? 0, total: null, link: '/services', color: '#7c3aed', bg: '#ede9fe', icon: '🦷' },
    { label: 'Bác sĩ chuyên khoa', value: stats?.doctors ?? 0, total: null, link: '/team', color: '#059669', bg: '#d1fae5', icon: '👨‍⚕️' },
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Tổng quan Future Dental — Implant 3D Clinic</div>
        </div>
      </div>
