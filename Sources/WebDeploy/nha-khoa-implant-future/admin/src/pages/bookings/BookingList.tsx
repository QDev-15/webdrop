    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Quản lý lịch hẹn từ khách hàng</div>
        </div>
            ...
            <tbody>
              {filtered.map(b => (
                <tr key={b.id}>
                  ...
                  <td style={{ color: 'var(--text-2)', fontSize: '13px' }}>{b.pref_service || '—'}</td>
              ...
              {filtered.length === 0 && (
                <tr><td colSpan={6} style={{ textAlign: 'center', color: 'var(--text-3)', padding: '32px' }}>Chưa có đặt lịch nào</td></tr>
              )}
            </tbody>
          </table>
        </div>
