...
export default function Sidebar() {
  ...
  const menu: MenuSection[] = [
    ...
    {
      section: 'Dịch vụ Implant',
      links: [{ to: '/services', icon: '🦷', label: 'Dịch vụ Implant' }],
    },
    {
      section: 'Đội ngũ',
      links: [{ to: '/team', icon: '👨‍⚕️', label: 'Bác sĩ chuyên sâu' }],
    },
    {
      section: 'Đặt lịch',
      links: [{ to: '/bookings', icon: '📅', label: 'Đặt lịch tư vấn', badge: newBookings }],
    },
    {
      section: 'Đánh giá',
      links: [{ to: '/testimonials', icon: '⭐', label: 'Đánh giá khách hàng' }],
    },
    {
      section: 'Khách hàng',
      links: [{ to: '/contacts', icon: '✉', label: 'Liên hệ', badge: newContacts }],
    },
    {
      section: 'Media',
      links: [{ to: '/media', icon: '🗂', label: 'Thư viện ảnh' }],
    },
    {
      section: 'Hệ thống',
    ...
    <div className="admin-sidebar">
      <div className="sidebar-logo">
        ...
        <div className="sidebar-logo-text">
          <div>Future Dental</div>
          <div className="sidebar-logo-sub">Implant 3D Clinic</div>
        </div>
      </div>
