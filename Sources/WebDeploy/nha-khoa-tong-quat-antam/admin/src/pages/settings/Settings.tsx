...
const FIELDS: Record<string, Array<{ key: string; label: string; type?: string; rows?: number }>> = {
  ...
  stats: [
    ...
    { key: 'stat_satisfaction', label: 'Tỷ lệ hài lòng' },
    { key: 'stat_pressure', label: 'Áp lực (luôn = 0 ☺)' },
  ],
  about: [
    { key: 'calm_quote', label: 'Triết lý (câu trích dẫn)', type: 'textarea', rows: 3 },
    { key: 'calm_attr_name', label: 'Tên người trích dẫn' },
    { key: 'calm_attr_role', label: 'Chức danh người trích dẫn' },
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Cấu hình thông tin phòng khám</div>
        </div>
