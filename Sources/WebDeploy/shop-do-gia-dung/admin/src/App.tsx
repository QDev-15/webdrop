...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/categories" element={<ProtectedRoute><ProductCategoryList /></ProtectedRoute>} />
      <Route path="/categories/new" element={<ProtectedRoute><ProductCategoryForm /></ProtectedRoute>} />
      <Route path="/categories/:id" element={<ProtectedRoute><ProductCategoryForm /></ProtectedRoute>} />
      ...
      <Route path="/slides/:id" element={<ProtectedRoute><HeroSlideForm /></ProtectedRoute>} />
    </Routes>
  )
}
