  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <div className="page-header">
        <div><div className="page-title">{isEdit ? 'Chỉnh sửa mốc thời gian' : 'Thêm mốc thời gian mới'}</div></div>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16 }}>
          <div className="form-group">
            ...
            <input id="year" type="text" className="form-control" value={form.year} onChange={e => set('year', e.target.value)} placeholder="2019 hoặc 2020 — 2021" required />
          </div>
          <div className="form-group">
            <label className="form-label" htmlFor="title">Tiêu đề *</label>
            <input id="title" type="text" className="form-control" value={form.title} onChange={e => set('title', e.target.value)} placeholder="UI Designer tại Agency Digital Craft" required />
          </div>
        </div>
        <div className="form-group">
