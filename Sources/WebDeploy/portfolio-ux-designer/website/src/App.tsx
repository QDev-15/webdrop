...
function AppShell() {
  ...
  return (
    <>
      <div className="pux-ambient"><span className="b1"></span><span className="b2"></span><span className="b3"></span></div>
      <Header />
      <Routes>
      ...
      <Footer />
      <div className="zf">
        <span className="zf-tip">Nhắn Zalo cho Linh</span>
        <a
          href={`https://zalo.me/${(settings.zalo_phone || '0902345678').replace(/\D/g, '')}`}
          target="_blank"
