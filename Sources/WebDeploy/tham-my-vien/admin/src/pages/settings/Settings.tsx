    ...
    <div>
      ...
      <form onSubmit={handleSave} className="card">
        {tab === 'general' && (
          <div style={{ display: 'grid', gap: 16 }}>
            <div className="form-group">
              <label className="form-label">Tên thẩm mỹ viện</label>
              <input className="form-control" value={get('site_name')} onChange={e => set('site_name', e.target.value)} placeholder="Thẩm Mỹ Viện Quốc Tế" />
            </div>
            <div className="form-group">
              <label className="form-label">Tagline / Slogan</label>
              <input className="form-control" value={get('site_tagline')} onChange={e => set('site_tagline', e.target.value)} placeholder="Medical Aesthetics" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input className="form-control" type="email" value={get('site_email')} onChange={e => set('site_email', e.target.value)} placeholder="info@thammy.vn" />
            </div>
            <div className="form-group">
              <label className="form-label">Địa chỉ</label>
              <input className="form-control" value={get('site_address')} onChange={e => set('site_address', e.target.value)} placeholder="123 Nguyễn Trãi, Quận 1, TP.HCM" />
            </div>
            <div className="form-group">
              <label className="form-label">Giờ làm việc</label>
              <input className="form-control" value={get('working_hours')} onChange={e => set('working_hours', e.target.value)} placeholder="Thứ 2 – Thứ 7: 8:00 – 20:00 | Chủ nhật: 9:00 – 17:00" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <label className="form-label">Số giấy phép CSYT</label>
              <input className="form-control" value={get('license_number')} onChange={e => set('license_number', e.target.value)} placeholder="Giấy phép số XXX/BYT-CSYT" />
            </div>
            <div style={{ borderTop: '1px solid var(--border)', paddingTop: 16, marginTop: 4 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[['stat_cases','Ca thực hiện'],['stat_doctors','Số bác sĩ'],['stat_years','Năm kinh nghiệm'],['stat_satisfaction','Tỷ lệ hài lòng (%)']].map(([k, l]) => (
        ...
        {tab === 'hero' && (
          <div style={{ display: 'grid', gap: 16 }}>
            <div className="form-group">
              <label className="form-label">Badge trên Hero (VD: "Thẩm Mỹ Y Khoa Cao Cấp")</label>
            ...
            <div className="form-group">
              ...
              <input className="form-control" value={get('hero_title_1')} onChange={e => set('hero_title_1', e.target.value)} placeholder="Vẻ đẹp" />
            </div>
            <div className="form-group">
              <label className="form-label">Dòng tiêu đề italic (màu vàng)</label>
              <input className="form-control" value={get('hero_title_em')} onChange={e => set('hero_title_em', e.target.value)} placeholder="hoàn hảo" />
            </div>
            <div className="form-group">
              <label className="form-label">Dòng tiêu đề 3</label>
              <input className="form-control" value={get('hero_title_3')} onChange={e => set('hero_title_3', e.target.value)} placeholder="từ chuyên gia." />
            </div>
            <div className="form-group">
