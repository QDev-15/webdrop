...
// Đặt title (giữ nguyên hành vi cũ) + meta description/canonical/OG theo ĐÚNG trang hiện tại.
// description là optional — trang nào không truyền vẫn hoạt động như trước (chỉ đổi title).
