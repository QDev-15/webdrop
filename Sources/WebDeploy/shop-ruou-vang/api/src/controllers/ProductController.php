...
class ProductController {
    ...
    private const BASE_FIELDS = [
        ...
        // AI thêm cột riêng — schema.sql có thêm origin/abv/volume/occasion/sold (rượu vang)
        'origin' => 's', 'abv' => 'f', 'volume' => 'i', 'occasion' => 's', 'sold' => 'i',
    ];
    ...
    public function store(): void {
        ...
        foreach (self::BASE_FIELDS as $field => $type) {
            $cols[]   = $field;
            $marks[]  = '?';
            $default  = $field === 'status' ? 'published' : ($field === 'rating' ? 5 : ($field === 'in_stock' ? 1 : ($field === 'volume' ? 750 : '')));
