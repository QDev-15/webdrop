...
const EMPTY: FormData = { author_name: '', author_role: '', author_avatar: '', content: '', rating: 5, sort_order: 0 }
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-row">
          <div className="form-group" style={{ flex: 1 }}>
            ...
            <input type="text" className="form-control" value={form.author_name} onChange={e => set('author_name', e.target.value)} placeholder="VD: Minh Anh" />
          </div>
          <div className="form-group" style={{ flex: 1 }}>
            <label>Chức danh / khu vực</label>
            <input type="text" className="form-control" value={form.author_role} onChange={e => set('author_role', e.target.value)} placeholder="VD: Giám đốc kinh doanh, TP.HCM" />
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group" style={{ flex: 1 }}>
            ...
            <input type="number" className="form-control" value={form.rating} onChange={e => set('rating', Number(e.target.value))} min={1} max={5} />
          </div>
          <div className="form-group" style={{ flex: 1 }}>
