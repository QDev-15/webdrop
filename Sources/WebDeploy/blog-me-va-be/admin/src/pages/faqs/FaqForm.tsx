...
const empty: FaqForm = {
  question: '', answer: '', sort_order: 0, status: 'published',
}
    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={form.question} onChange={e => set('question', e.target.value)} placeholder="Vd: Làm sao để chia sẻ câu chuyện lên Cỏ Non?" required />
        </div>
        <div className="form-group">
