    ...
    <div className="admin-page">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Cỏ Non Blog — Quản trị hệ thống</div>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#e9f4ee' }}>🖼</div>
            ...
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#fdf0e0' }}>📝</div>
