...
export const api = {
  ...
  // Dùng cho danh sách có phân trang admin (vd ProductList) — đọc header X-Total-Count
  // thay vì bọc { items, total } trong body (giữ nguyên rule "endpoint trả array thuần").
