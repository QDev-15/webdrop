...
export default function CheckoutPage() {
  ...
  useDocumentMeta({
    title: 'Thanh toán — VIOLETTE Fine Jewelry',
    description: 'Hoàn tất đơn hàng trang sức VIOLETTE — chọn phương thức thanh toán khi nhận hàng (COD) hoặc chuyển khoản qua SePay.',
  })
