...
CREATE TABLE IF NOT EXISTS products (
    ...
    -- shop-trang-suc: cột riêng cho trang sức — khớp san-pham.html (chất liệu/tông màu/dịp sử dụng/đã bán)
    material     TEXT NOT NULL DEFAULT '',   -- slug: bac-925 | vang-18k | vang-24k | da-quy | dinh-da
    tone         TEXT NOT NULL DEFAULT '',   -- slug: vang | bac | hong-vang
    occasion     TEXT NOT NULL DEFAULT '',   -- slug: hang-ngay | du-tiec | cuoi-hoi | qua-tang
    sold         INTEGER NOT NULL DEFAULT 0,
    theme        TEXT NOT NULL DEFAULT ''    -- CSV: moi-ve,ban-chay,uu-dai,qua-tang — khớp index.html THEMED-SECTIONS
);
...
-- shop-trang-suc EXTENSION — 1 bảng mới (testimonials) khớp UI thực trong template gốc (index.html,
-- mục "Khách hàng nói gì" — LIST-ELEGANT). Không có bảng coupons vì gio-hang.html gốc không có ô
-- nhập mã giảm giá / voucher-card nào.
