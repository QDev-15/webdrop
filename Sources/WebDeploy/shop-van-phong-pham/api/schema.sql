...
CREATE TABLE IF NOT EXISTS products (
    ...
    brand        TEXT NOT NULL DEFAULT '',   -- thương hiệu (Thiên Long, Pentel, Deli...) — dùng cho filter "Thương hiệu"
    theme        TEXT NOT NULL DEFAULT '',   -- padded-pipe "|ban-chay|giam-gia|" — dùng cho section trang chủ
