...
export default function CheckoutPage() {
  ...
  useDocumentMeta({
    title: `Thanh toán — ${settings.site_name || 'OFFICEHUB'}`,
    description: `Hoàn tất đơn hàng tại ${settings.site_name || 'OFFICEHUB'} — chọn phương thức thanh toán COD hoặc chuyển khoản qua SePay.`,
  })
