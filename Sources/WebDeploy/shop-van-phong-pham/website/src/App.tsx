...
// (component fetch API render thêm [data-reveal] elements SAU khi IO được setup lần đầu).
//
// Site này dùng biến thể SEARCH-FIRST UNIFIED — index.html gốc KHÔNG có hero/marketing section,
// catalog đầy đủ (filter toolbar ngang + grid + pagination) nằm ngay ở route "/". Toàn bộ nội
// dung marketing (hero, brand story, stat bar, service grid, testimonials, policy, CTA) chuyển
// sang trang "/dich-vu" (ServicesPage), khớp đúng dich-vu.html của template gốc.
function AppShell() {
