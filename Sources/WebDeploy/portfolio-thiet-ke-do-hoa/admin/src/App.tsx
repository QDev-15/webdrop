...
import ToolSkillList from './pages/tools/ToolSkillList'
import ToolSkillForm from './pages/tools/ToolSkillForm'
  ...
  return (
    <AdminLayout>
      <Routes>
        ...
        <Route path="/tools"                  element={<ToolSkillList />} />
        <Route path="/tools/new"              element={<ToolSkillForm />} />
        <Route path="/tools/:id/edit"         element={<ToolSkillForm />} />
