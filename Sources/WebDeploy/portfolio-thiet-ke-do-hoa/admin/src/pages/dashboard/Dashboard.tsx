    ...
    <div className="admin-page">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">KHOA Design Studio — Quản trị portfolio</div>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#fbe7e4' }}>🖼</div>
            ...
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#fbe7e4' }}>🛠</div>
              <div className="stat-card-value">{stats?.tools ?? 0}</div>
              <div className="stat-card-label">Công cụ & kỹ năng</div>
              <Link to="/tools" className="btn-ghost btn-sm" style={{ marginTop: 12 }}>Quản lý →</Link>
            </div>
