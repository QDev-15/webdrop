  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <div className="page-title">Hành trình làm nghề</div>
          <div className="page-sub">Hiển thị trang Về tôi ({items.length} mốc)</div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {items.map(t => (
            <div key={t.id} className="card" style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
              <div style={{ fontWeight: 700, fontSize: 14, color: 'var(--accent)', flexShrink: 0, width: 100 }}>{t.year}</div>
