    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <div className="form-group">
            <label className="form-label">Bối cảnh (vd: Đà Lạt, 2025)</label>
            <input type="text" className="form-control" value={form.author_title} onChange={e => set('author_title', e.target.value)} />
          </div>
        </div>
        <div className="form-group">
