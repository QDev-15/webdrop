...
const emptyForm: ItemForm = {
  ...
  rating: 5, source: 'Google Maps', sort_order: 0, status: 'published',
}
    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <div className="form-group">
            <label className="form-label">Chức vụ / Ghi chú</label>
            <input type="text" className="form-control" value={form.author_title} onChange={e => set('author_title', e.target.value)} placeholder="Vd: Khách quen 5 năm" />
          </div>
        </div>
        <div className="form-group">
