...
class ProductController {
    ...
    private const BASE_FIELDS = [
        ...
        // AI thêm cột riêng — schema.sql có thêm brand/material/style/warranty/movement/water_resist/diameter/sold/limited/gallery
        'brand' => 's', 'material' => 's', 'style' => 's', 'warranty' => 's', 'movement' => 's',
        'water_resist' => 's', 'diameter' => 'i', 'sold' => 'i', 'limited' => 'i', 'gallery' => 's',
    ];
    ...
    public function index(): void {
        ...
        $params   = [];
        if ($search !== '') {
            $whereSql = '(p.name LIKE ? OR p.description LIKE ? OR p.brand LIKE ?)';
