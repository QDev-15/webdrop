        ...
        <div className="card">
          ...
          {activeTab === 'general' && (
            <div>
              ...
              <div className="form-group">
                ...
                <input className="form-control" value={s.site_logo_text ?? ''} onChange={e => set('site_logo_text', e.target.value)} placeholder="Digital" />
              </div>
              <div className="form-group">
          ...
          {activeTab === 'content' && (
            <div>
              ...
              <div style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-3)', textTransform: 'uppercase', letterSpacing: '.5px', margin: '16px 0 10px' }}>Trang chủ — Giải pháp lõi</div>
