    ...
    <div className="admin-page">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Digital Innovation — Quản trị hệ thống</div>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#f3e8ff' }}>🖼</div>
            ...
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#e8f4ef' }}>⚙</div>
