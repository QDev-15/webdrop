    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={form.question} onChange={e => set('question', e.target.value)} placeholder="Vd: Chi phí/báo giá được tính như thế nào?" required />
        </div>
        <div className="form-group">
