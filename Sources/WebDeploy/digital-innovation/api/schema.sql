...
-- ── SERVICES (Giải pháp / Dịch vụ công nghệ) ──────────────────────────────
-- Hiển thị ở cả trang chủ ("Giải pháp lõi") và trang /dich-vu (danh sách đầy đủ)
...
CREATE TABLE IF NOT EXISTS pricing_plans (
    ...
    cta_text    TEXT NOT NULL DEFAULT 'Yêu cầu demo',
