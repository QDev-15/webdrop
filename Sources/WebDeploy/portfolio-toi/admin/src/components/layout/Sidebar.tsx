...
// ⚠️ BẮT BUỘC — interface với optional fields để tránh TS2339
...
export default function Sidebar() {
  ...
  const menuStructure: MenuSection[] = [
    ...
    },
    {
      section: 'Kỹ năng',
      links: [
        { to: '/skill-groups', icon: '📂', label: 'Nhóm kỹ năng' },
    ...
    <div className="admin-sidebar">
      ...
      <div className="sidebar-footer">
        ...
        <button
          ...
          style={{ width: '100%', background: 'none', border: 'none', textAlign: 'left', marginTop: 4 }}
        >
          <span className="icon">↩</span>
          <span>Đăng xuất</span>
        </button>
