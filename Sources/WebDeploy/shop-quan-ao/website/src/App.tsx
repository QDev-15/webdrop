...
function ZaloFloat() {
  ...
  if (!zalo) return null
  return (
    <div className="qa-zalo-float" aria-label="Chat Zalo">
      <div className="qa-zalo-tooltip">Chat Zalo</div>
      <a href={`https://zalo.me/${zalo}`} className="qa-zalo-btn" target="_blank" rel="noopener noreferrer" aria-label="Liên hệ qua Zalo">
