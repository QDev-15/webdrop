...
-- ── PROJECTS (case study minh họa — du-an.html + du-an-chi-tiet-1/2.html) ──
...
CREATE TABLE IF NOT EXISTS pricing_plans (
    ...
    description TEXT NOT NULL DEFAULT '',
    price       TEXT NOT NULL,
    unit        TEXT NOT NULL DEFAULT '/ tranh',
