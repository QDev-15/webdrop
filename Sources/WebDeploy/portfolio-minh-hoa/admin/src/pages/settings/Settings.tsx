        ...
        <div className="card">
          ...
          {activeTab === 'general' && (
            <div>
              ...
              <div className="form-group">
                ...
                <input className="form-control" value={s.service_area ?? ''} onChange={e => set('service_area', e.target.value)} placeholder="Hà Nội, Việt Nam — nhận dự án từ xa toàn quốc & quốc tế" />
              </div>
            </div>
          )}
          ...
          {activeTab === 'content' && (
            <div>
              ...
              <p style={{ fontSize: 12, color: 'var(--text-3)', marginBottom: 20 }}>Dùng dấu *từ* để tô màu nhấn (vd: "Mình là Lam Trúc — vẽ nhân vật, *vẽ cả câu chuyện*").</p>

              <div style={sectionLabelStyle}>Trang chủ — Giới thiệu</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.home_intro_label ?? ''} onChange={e => set('home_intro_label', e.target.value)} /></div>
              ...
              <div className="form-group"><label className="form-label">Đoạn giới thiệu</label><textarea className="form-control" rows={3} value={s.home_intro_text ?? ''} onChange={e => set('home_intro_text', e.target.value)} /></div>
              {[1, 2, 3].map(i => (
                <div key={i} style={{ display: 'grid', gridTemplateColumns: '60px 1fr 2fr', gap: 12, marginBottom: 12 }}>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label">Icon</label>
                    <input className="form-control" value={s[`feature${i}_icon`] ?? ''} onChange={e => set(`feature${i}_icon`, e.target.value)} />
                  </div>
                  <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <div style={sectionLabelStyle}>Trang chủ — Testimonial teaser &amp; CTA</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.home_testi_label ?? ''} onChange={e => set('home_testi_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề</label><input className="form-control" value={s.home_testi_title ?? ''} onChange={e => set('home_testi_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề CTA cuối trang</label><input className="form-control" value={s.home_cta_title ?? ''} onChange={e => set('home_cta_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Mô tả CTA</label><textarea className="form-control" rows={2} value={s.home_cta_text ?? ''} onChange={e => set('home_cta_text', e.target.value)} /></div>
              ...
              <div className="form-group"><label className="form-label">Tiêu đề CTA cuối trang</label><input className="form-control" value={s.projects_cta_title ?? ''} onChange={e => set('projects_cta_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Mô tả CTA</label><textarea className="form-control" rows={2} value={s.projects_cta_text ?? ''} onChange={e => set('projects_cta_text', e.target.value)} /></div>

              <div style={sectionLabelStyle}>Trang Dịch vụ — Hero &amp; điều bạn nhận được</div>
              <div className="form-group"><label className="form-label">Tiêu đề Hero</label><input className="form-control" value={s.services_hero_title ?? ''} onChange={e => set('services_hero_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Mô tả Hero</label><textarea className="form-control" rows={2} value={s.services_hero_sub ?? ''} onChange={e => set('services_hero_sub', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Nhãn mục cam kết</label><input className="form-control" value={s.services_feat_label ?? ''} onChange={e => set('services_feat_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề mục cam kết</label><input className="form-control" value={s.services_feat_title ?? ''} onChange={e => set('services_feat_title', e.target.value)} /></div>
              {[1, 2, 3, 4].map(i => (
                <div key={i} style={{ display: 'grid', gridTemplateColumns: '60px 1fr 2fr', gap: 12, marginBottom: 12 }}>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label">Icon</label>
                    <input className="form-control" value={s[`service_feature${i}_icon`] ?? ''} onChange={e => set(`service_feature${i}_icon`, e.target.value)} />
                  </div>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label">Mục {i} — tiêu đề</label>
                    <input className="form-control" value={s[`service_feature${i}_title`] ?? ''} onChange={e => set(`service_feature${i}_title`, e.target.value)} />
                  </div>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label">Mục {i} — mô tả</label>
                    <input className="form-control" value={s[`service_feature${i}_text`] ?? ''} onChange={e => set(`service_feature${i}_text`, e.target.value)} />
                  </div>
                </div>
              ))}

              <div style={sectionLabelStyle}>Trang Dịch vụ — Quy trình 5 bước</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.process_label ?? ''} onChange={e => set('process_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề</label><input className="form-control" value={s.process_title ?? ''} onChange={e => set('process_title', e.target.value)} /></div>
              {[1, 2, 3, 4, 5].map(i => (
                <div key={i} style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 100px', gap: 12, marginBottom: 12 }}>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                  ...
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <input className="form-control" value={s[`process${i}_text`] ?? ''} onChange={e => set(`process${i}_text`, e.target.value)} />
                  </div>
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label">Thời lượng</label>
                    <input className="form-control" value={s[`process${i}_time`] ?? ''} onChange={e => set(`process${i}_time`, e.target.value)} />
                  </div>
                </div>
              ))}

              <div style={sectionLabelStyle}>Trang Dịch vụ — Bảng giá, FAQ &amp; CTA</div>
              <div className="form-group"><label className="form-label">Nhãn bảng giá</label><input className="form-control" value={s.pricing_label ?? ''} onChange={e => set('pricing_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề bảng giá</label><input className="form-control" value={s.pricing_title ?? ''} onChange={e => set('pricing_title', e.target.value)} /></div>
              ...
              <div className="form-group"><label className="form-label">Nhãn FAQ</label><input className="form-control" value={s.faq_label ?? ''} onChange={e => set('faq_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề FAQ</label><input className="form-control" value={s.faq_title ?? ''} onChange={e => set('faq_title', e.target.value)} /></div>
              <p style={{ fontSize: 13, color: 'var(--text-2)', margin: '0 0 20px' }}>
                Từng câu hỏi được quản lý ở mục <strong>FAQ</strong> riêng trong menu Nội dung.
              </p>
              <div className="form-group"><label className="form-label">Tiêu đề CTA cuối trang</label><input className="form-control" value={s.services_cta_title ?? ''} onChange={e => set('services_cta_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Mô tả CTA</label><textarea className="form-control" rows={2} value={s.services_cta_text ?? ''} onChange={e => set('services_cta_text', e.target.value)} /></div>
              ...
              <div style={sectionLabelStyle}>Trang Về tôi — Phong cách</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.style_label ?? ''} onChange={e => set('style_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề</label><input className="form-control" value={s.style_title ?? ''} onChange={e => set('style_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Đoạn văn 1</label><textarea className="form-control" rows={3} value={s.style_text1 ?? ''} onChange={e => set('style_text1', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Đoạn văn 2</label><textarea className="form-control" rows={2} value={s.style_text2 ?? ''} onChange={e => set('style_text2', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Ảnh minh họa (URL)</label><input className="form-control" value={s.style_image ?? ''} onChange={e => set('style_image', e.target.value)} /></div>

              <div style={sectionLabelStyle}>Trang Về tôi — Công cụ</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.tools_label ?? ''} onChange={e => set('tools_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề</label><input className="form-control" value={s.tools_title ?? ''} onChange={e => set('tools_title', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Đoạn văn 1</label><textarea className="form-control" rows={3} value={s.tools_text1 ?? ''} onChange={e => set('tools_text1', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Đoạn văn 2</label><textarea className="form-control" rows={2} value={s.tools_text2 ?? ''} onChange={e => set('tools_text2', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Ảnh minh họa (URL)</label><input className="form-control" value={s.tools_image ?? ''} onChange={e => set('tools_image', e.target.value)} /></div>

              <div style={sectionLabelStyle}>Trang Về tôi — Nhận xét &amp; CTA cuối trang</div>
              <div className="form-group"><label className="form-label">Nhãn</label><input className="form-control" value={s.about_testi_label ?? ''} onChange={e => set('about_testi_label', e.target.value)} /></div>
              <div className="form-group"><label className="form-label">Tiêu đề</label><input className="form-control" value={s.about_testi_title ?? ''} onChange={e => set('about_testi_title', e.target.value)} /></div>
              ...
              <div className="form-group"><label className="form-label">Mô tả CTA</label><textarea className="form-control" rows={2} value={s.about_cta_text ?? ''} onChange={e => set('about_cta_text', e.target.value)} /></div>
