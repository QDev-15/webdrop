...
function AppShell() {
  ...
  // Chuyển trang qua <Link> không tự cuộn lên đầu (khác hẳn hành vi full page load) —
  // bắt buộc reset scroll mỗi khi đổi route để không giữ nguyên vị trí cuộn trang cũ.
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [location.pathname])
