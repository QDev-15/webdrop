...
export default function CheckoutPage() {
  ...
  useDocumentMeta({
    title: `Thanh toán — ${settings.site_name || 'MỘC AN'}`,
    description: `Hoàn tất đơn hàng tại ${settings.site_name || 'MỘC AN'} — chọn phương thức thanh toán COD hoặc chuyển khoản qua SePay.`,
  })
