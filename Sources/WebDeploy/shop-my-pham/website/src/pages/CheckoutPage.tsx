...
export default function CheckoutPage() {
  ...
  useDocumentMeta({
    title: `Thanh Toán — ${settings.site_name || 'LUMIÈRE Beauty'}`,
    description: `Hoàn tất đặt hàng tại ${settings.site_name || 'LUMIÈRE Beauty'}.`,
  })
        ...
        <div className="shop-checkout-layout">
          ...
          <aside>
            <div className="shop-checkout-summary">
              ...
              {couponDiscount > 0 && (
                <div className="shop-checkout-summary-row" style={{ color: 'var(--rose-gold, #c98a8a)' }}>
