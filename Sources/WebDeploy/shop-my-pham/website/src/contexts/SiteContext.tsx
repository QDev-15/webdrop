...
export function SiteProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    Promise.all([
      ...
      // per_page cao để lấy toàn bộ 36 sản phẩm cho trang chủ (4 section theo theme/danh mục) và
      // sản phẩm liên quan — ProductsPage tự gọi phân trang riêng (per_page=12) cho trang danh sách đầy đủ.
