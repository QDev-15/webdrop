...
function ZaloFloat() {
  ...
  if (!zalo) return null
  return (
    <div className="tp-zalo-float">
      <div className="tp-zalo-tooltip">Chat Zalo</div>
      <a href={`https://zalo.me/${zalo}`} className="tp-zalo-btn" target="_blank" rel="noopener noreferrer" aria-label="Liên hệ qua Zalo">
