...
CREATE TABLE IF NOT EXISTS products (
    ...
    -- ▼ Cột riêng shop-thuc-pham-sach (theo chi-tiet-san-pham.html: tab Dinh dưỡng + Nguồn gốc + badges chứng nhận)
    unit         TEXT NOT NULL DEFAULT '',      -- đơn vị: bó / kg / hộp 10 quả / chai 500ml...
    certs        TEXT NOT NULL DEFAULT '',      -- pipe-separated, chỉ nhận giá trị "VietGAP|Organic|GlobalGAP" — khớp filter "Chứng nhận"
    gallery      TEXT NOT NULL DEFAULT '',      -- pipe-separated ảnh gallery bổ sung
    nutrition    TEXT NOT NULL DEFAULT '',      -- pipe-separated "Tên:Giá trị" — tab "Thông tin dinh dưỡng"
    origin_farm  TEXT NOT NULL DEFAULT '',      -- tên nông trại / nguồn gốc — tab "Nguồn gốc"
    harvest_note TEXT NOT NULL DEFAULT '',      -- ghi chú thời gian thu hoạch — tab "Nguồn gốc"
...
-- Phiếu giảm giá — module tự thêm (KHÔNG có sẵn trong scaffold), theo pattern gốc shop-thoi-trang/shop-rau-xanh.
...
-- Đánh giá khách hàng trang chủ (HORIZONTAL-SCROLL) — quản lý qua Settings nhóm "reviews" (theo pattern shop-rau-xanh),
-- không cần bảng riêng vì chỉ 4 mục cố định hiển thị ở trang chủ.
