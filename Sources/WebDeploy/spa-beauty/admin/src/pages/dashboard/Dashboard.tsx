...
export default function Dashboard() {
  ...
  const cards = [
    ...
    { icon: '👩', label: 'Chuyên viên',        value: stats.team,        link: '/team',         badge: 0 },
    { icon: '⭐', label: 'Đánh giá khách hàng',value: stats.testimonials,link: '/testimonials', badge: 0 },
  ]
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Tổng quan hệ thống Bella Spa</div>
        </div>
      ...
      <div className="card">
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
          ...
          <Link to="/team/new"         className="btn-ghost btn-sm">+ Thêm chuyên viên</Link>
