...
import ProductReviewForm from './pages/product-reviews/ProductReviewForm'
        ...
        <PrivateRoute>
          <AdminLayout>
            <Routes>
              ...
              <Route path="product-reviews/new" element={<ProductReviewForm />} />
              <Route path="product-reviews/:id/edit" element={<ProductReviewForm />} />
