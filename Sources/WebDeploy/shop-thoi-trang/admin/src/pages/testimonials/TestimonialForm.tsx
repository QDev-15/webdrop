      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-row">
          <div className="form-group" style={{ flex: 1 }}>
            ...
            <input type="text" value={form.author_name} onChange={e => set('author_name', e.target.value)} placeholder="VD: Nguyễn Thị A" />
          </div>
          <div className="form-group" style={{ flex: 1 }}>
            <label>Vai trò</label>
            <input type="text" value={form.author_role} onChange={e => set('author_role', e.target.value)} placeholder="VD: Khách hàng thường xuyên" />
          </div>
        </div>

        <div className="form-group">
          <label>URL Ảnh đại diện (để trống sẽ hiện chữ cái đầu tên)</label>
        ...
        <div className="form-row">
          ...
          <div className="form-group" style={{ flex: 2 }}>
            ...
            <input type="text" value={form.product_purchased} onChange={e => set('product_purchased', e.target.value)} placeholder="VD: Mua áo oversize" />
          </div>
        </div>
