...
const FIELD_MAP: Record<string, { key: string; label: string; type?: string; hint?: string }[]> = {
  general: [
    ...
    { key: 'working_hours',  label: 'Gio lam viec', hint: 'Vi du: Thu 2 – Thu 7: 8:00 – 20:00' },
  ],
  seo: [
  ...
  social: [
    ...
    { key: 'zalo',      label: 'So Zalo (khong dau cach)', hint: 'Vi du: 0901234567' },
  ],
  contact: [
  ...
  hero: [
    ...
    { key: 'stat_years',          label: 'Stat — So nam (vi du: 20+)' },
    { key: 'stat_years_label',    label: 'Stat — Nhan nam' },
    { key: 'stat_smiles',         label: 'Stat — So nu cuoi hai long' },
    { key: 'stat_smiles_label',   label: 'Stat — Nhan nu cuoi' },
    { key: 'stat_doctors',        label: 'Stat — So bac si' },
    { key: 'stat_doctors_label',  label: 'Stat — Nhan bac si' },
    { key: 'stat_satisfaction',   label: 'Stat — Ti le hai long' },
    { key: 'stat_satisfaction_label', label: 'Stat — Nhan hai long' },
  ],
  story: [
    { key: 'story_year',   label: 'Nam (vi du: Tu nam 2003)' },
    { key: 'story_title',  label: 'Tieu de phan cau chuyen' },
    { key: 'story_text',   label: 'Noi dung cau chuyen', type: 'textarea' },
    { key: 'story_image',  label: 'URL hinh anh cau chuyen' },
  ],
  cloudinary: [
