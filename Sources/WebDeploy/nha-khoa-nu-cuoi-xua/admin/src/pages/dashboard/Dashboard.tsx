...
export default function Dashboard() {
  ...
  const cards = [
    { label: 'Đặt lịch mới', value: stats?.new_bookings ?? 0, total: stats?.bookings ?? 0, link: '/bookings', color: '#1f7a6b', bg: '#e2efec', icon: '📅' },
    { label: 'Liên hệ mới',  value: stats?.new_contacts ?? 0, total: stats?.contacts ?? 0, link: '/contacts', color: '#c98a1f', bg: '#f4e6c8', icon: '✉' },
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Tổng quan Nụ Cười Xưa — Nha Khoa Phong Cách Retro</div>
        </div>
      </div>
