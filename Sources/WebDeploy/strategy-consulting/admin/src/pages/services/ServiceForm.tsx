...
const empty: ServiceForm = {
  icon: '🎯', title: '', description: '', sort_order: 0, status: 'published',
}
    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} className="card">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" value={form.title} onChange={e => set('title', e.target.value)} placeholder="Vd: Định hướng Chiến lược" required />
        </div>
        <div className="form-group">
