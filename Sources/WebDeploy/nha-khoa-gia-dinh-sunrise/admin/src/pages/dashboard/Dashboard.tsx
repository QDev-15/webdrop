...
export default function Dashboard() {
  ...
  const cards = [
    { label: 'Đặt lịch mới', value: stats?.new_bookings ?? 0, total: stats?.bookings ?? 0, link: '/bookings', color: '#2f8fd1', bg: '#e0f2fe', icon: '📅' },
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Tổng quan Sunrise — Nha Khoa Gia Đình</div>
        </div>
      </div>
