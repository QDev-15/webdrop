...
function ZaloFloat() {
  ...
  if (!zalo) return null
  return (
    <div className="gd-zalo-float" aria-label="Chat Zalo">
      <div className="gd-zalo-tooltip">Chat Zalo</div>
      <a href={`https://zalo.me/${zalo}`} className="gd-zalo-btn" target="_blank" rel="noopener noreferrer" aria-label="Liên hệ qua Zalo">
