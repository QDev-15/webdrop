        ...
        <div className="card" style={{ marginBottom: 24 }}>
          ...
          <form onSubmit={handleSave}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div className="form-group">
                <label className="form-label">Ghi chu danh muc (tuy chon)</label>
                <input type="text" className="form-control" value={form.category} onChange={e => set('category', e.target.value)} placeholder="Vd: Khu rang, Khu pha che... (template khong co filter tab)" />
              </div>
              <div className="form-group">
