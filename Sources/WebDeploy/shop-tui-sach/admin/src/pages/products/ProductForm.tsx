...
// Kích thước túi — khớp block filter "Kích thước" ở website/src/pages/ProductsPage.tsx
...
interface FormData {
  ...
  status: string
  sort_order: string
  // ▼ Field riêng theo template (san-pham.html có block filter "Kích thước") — đã thêm tương ứng vào
  ...
  return (
    <div className="admin-page">
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <div className="form-group">
          <label>Kích thước (dùng cho bộ lọc "Kích thước" ở trang Sản phẩm)</label>
