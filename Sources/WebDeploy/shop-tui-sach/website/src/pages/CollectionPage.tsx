...
export default function CollectionPage() {
  useDocumentMeta({
    title: 'Bộ sưu tập — Maison Cuir',
    description: 'Khám phá các dòng bộ sưu tập túi da thủ công của Maison Cuir — dòng da thật, dòng giới hạn số lượng, dòng công sở thanh lịch.',
  })
