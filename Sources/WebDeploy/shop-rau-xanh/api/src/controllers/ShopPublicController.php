...
class ShopPublicController {
    ...
    // SEO: sitemap.xml động — route tĩnh (App.tsx) + toàn bộ sản phẩm published.
    // Ngoại lệ mở rộng file scaffold tĩnh này cho mục đích SEO (giống pattern coupon ở trên).
    public function sitemap(): void {
        ...
        $staticRoutes = [
            '/', '/san-pham', '/ve-chung-toi', '/khuyen-mai',
            '/lien-he', '/chinh-sach-bao-mat', '/dieu-khoan',
        ];
