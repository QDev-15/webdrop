  ...
  const menuStructure: MenuSection[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { to: '/menu-items', icon: '☕', label: 'Món & thức uống' },
      ],
    },
    {
      section: 'Nội dung',
      links: [
        { to: '/gallery', icon: '📸', label: 'Không gian & ảnh' },
    ...
    },
    {
      section: 'Khách hàng',
      links: [
        { to: '/contacts', icon: '✉', label: 'Đặt bàn / Liên hệ', badge: newContacts },
      ],
    },
    {
      section: 'Hệ thống',
  ...
  return (
    <div className="admin-sidebar">
      <div className="sidebar-logo">
        <span>🌙</span>
        <div>
          <div style={{ fontSize: 13, fontWeight: 600, color: '#fff' }}>NOX Admin</div>
          <div style={{ fontSize: 10, color: 'rgba(255,255,255,.35)', marginTop: 1 }}>Cà Phê Đêm Muộn</div>
        </div>
      </div>
