...
const empty: FormData = { question: '', answer: '', page: 'gioi-thieu', sort_order: 0, status: 'published' }
...
export default function FaqForm() {
  ...
  useEffect(() => {
    ...
    api.get<Record<string, unknown>>(`/faqs/${id}`)
      .then(d => setForm({
        question: String(d.question ?? ''), answer: String(d.answer ?? ''), page: String(d.page ?? 'gioi-thieu'),
