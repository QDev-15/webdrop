    ...
    <div className="admin-page">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">La Bàn Tài Chính — Quản trị blog</div>
        </div>
      </div>
        ...
        <>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-card-icon" style={{ background: '#e9f0e0' }}>🖼</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-card-label">Bài viết ({stats?.published ?? 0} đã xuất bản)</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-card-label">Đánh giá độc giả</div>
