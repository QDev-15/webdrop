      ...
      <form onSubmit={handleSubmit} className="card">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16 }}>
          <div className="form-group">
            ...
            <input id="year" type="text" className="form-control" value={form.year} onChange={e => set('year', e.target.value)} placeholder="2022" required />
          </div>
          <div className="form-group">
            <label className="form-label" htmlFor="title">Tiêu đề *</label>
            <input id="title" type="text" className="form-control" value={form.title} onChange={e => set('title', e.target.value)} placeholder="La Bàn Tài Chính chính thức ra mắt" required />
          </div>
        </div>
        <div className="form-group">
