...
│       ├── shop-ami-mobile/        ← ✅ 1 template + WebDeploy đầy đủ (RETRO-BOLD identity, Mode B themed-sections, CSS prefix mb- — xem bảng tra nhanh)
