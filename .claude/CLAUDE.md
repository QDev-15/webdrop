...
- [ ] Bất động sản — **IN PROGRESS** (3 template: `Real-Estate/green-valley-residence` Loại hình B GLASS-MODERN, `Real-Estate/nha-dat-viet` Loại hình A CLEAN-CORPORATE (build cũ, sai ý — CHƯA retrofit), `Real-Estate/rao-nha` Loại hình A FRESH-MINIMAL (build đúng theo Bước A đã sửa 2026-08-23, tham khảo đúng mô hình marketplace) — xem block ghi chú kỹ thuật bên dưới)
